...
public class AdjGraph implements Graph {
	...
	public void topSort() {
		...
		LinkedList<Integer> eligiblev = new LinkedList<Integer>();
	...
	for (int k = 0; k < indegrees.length; k++){
		if(indegrees[k] == 0){ 
			eligiblev.addFirst(k);
		}
	}
	
	while(!eligiblev.isEmpty()) {
		int curr = eligiblev.getFirst();
		sorted.add(nodeList.get(eligiblev.removeFirst()));
		LinkedList<Integer> n = adjList.get(curr);
